...
# Prihlaseni do predem vytvorene databaze s nazvem "Senzor" a tabulkou: CREATE TABLE data (Datum VARCHAR(255), Teplota VARCHAR(255), NadmorskaVyska VARCHAR(255), TlakVzduchu VARCHAR(255));
